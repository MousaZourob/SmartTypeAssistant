...
def get_accuracy(characters): # Takes in the number of accurate keypresses and the total number of characters, returns the % accuracy
    global total_char_count
    accuracy = (characters/total_char_count)*100
    round(accuracy, 1)
...
accuracy = get_accuracy(char_counter) #gets the % accuracy from the method
